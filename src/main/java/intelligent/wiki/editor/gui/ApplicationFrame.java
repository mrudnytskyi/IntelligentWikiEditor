...
public abstract class ApplicationFrame extends JFrame implements
	...
	protected class Action extends AbstractAction {
		 ...
		 * will be ignored.
		 *
		 * @param listener For details, see
		 *                 {@link Action#actionPerformed(ActionEvent)
		 *                 actionPerformed()} method
		 * @param name     action name
		 * @param id       unique action id, used to recognize action, stored in
		 ...
		 * @param bigIcon  path to big icon, used in toolbars and so on
		 * @param key      key, used to invoke action, stored in {@link KeyEvent}
		 *                 constant
		 */
